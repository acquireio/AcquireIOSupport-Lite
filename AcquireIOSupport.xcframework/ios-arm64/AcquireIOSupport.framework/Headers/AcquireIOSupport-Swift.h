...
/// Allow Access
- (void)dismissChatSupport;
@end

@class UIViewController;
enum ChannelType : NSInteger;
@class NSNumber;
...
/// @available Available in SDK version 1.0.0 or later
- (void)showSupport:(UIViewController * _Nonnull)viewController withMessage:(NSString * _Nonnull)message;
/// Start a connection session with acquire server. After calling startSession, the AcquireIODelegate delegate will receive either didChangeConnectionStatus: or onError:.
/// <em>setAccount: should be called first.</em>
- (void)startSession;
/// <ul>
///   <li>
///     Use this method to start direct Chat, Audio or Video call request to agent. By this method , Audio/Video chat request  will be visible to the agent and on answer to that chat will start Audio/Video call as soon as chat is connected.
///   </li>
///   <li>
///   </li>
///   <li>
///     @param ChannelType - chat, audio, video
///   </li>
///   <li>
///   </li>
///   <li>
...
///   </li>
/// </ul>
- (void)startDirectSupportChatWithType:(enum ChannelType)type;
...
/// <ul>
///   <li>
///     Get Agents Id, after acquire session Connected
///   </li>
///   <li>
///   </li>
///   <li>
...
///   </li>
/// </ul>
- (NSArray<NSNumber *> * _Nonnull)getOnlineAgentIDs SWIFT_WARN_UNUSED_RESULT;
@end
...
/// <ul>
///   <li>
///     if yes/true hide error message show when a device has no internet connection.
///   </li>
///   <li>
///     if No/false,notify error message show when a device has no internet connection.
///   </li>
///   <li>
///     This is optional, if not set default @NO/false
///   </li>
///   <li>
///     Initialize dictionary key: DisableNetworkMessage
///   </li>
/// </ul>
@property (nonatomic, readonly) BOOL disableNetworkMessage;
...
/// *
/// *  @available Available in SDK version 1.1.5 or later
...
/// @param data Dictionary/[String : Any]
/// @available Available in SDK version 1.1.0 or later
- (void)didReceiveNewMessage:(id _Nonnull)message;
@end
